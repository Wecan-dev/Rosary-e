...
<img id="iso" src="assets/img/logo.png">
</a>
          </div>
        </div>
...
<span class="hamburger-inner"></span>
        ...
        <div class="navbar-collapse offcanvas-collapse">
          <ul class="navbar-nav mr-autos">
            <li class="nav-item">
              <a class="nav-link" data="offcanvas" href="new-in.html">
New in
</a>
            </li>
            <li class="nav-item">
...
Recomendados
            ...
            <li class="nav-item">
              <a class="nav-link" data="offcanvas" href="tienda.html">
Productos
</a>
            </li>
            <li class="nav-item">
...
outlet
            ...
            <ul class="nav-icon">
              <li>
                <a class="nav-link" data="offcanvas" href="">
<img src="assets/img/profile@2x.png">
</a>
              </li>
              <li>
                <a class="nav-link" data="offcanvas" href="">
...
<img src="assets/img/bag@2x.png">
  ...
  <section class="general-banner">
    <img src="assets/img/productos/image_1.png">
...
Bronce
          ...
          <div class="shop-sidebar__newsletter">
            ...
            <a href="">
<img src="assets/img/productos/envelope.png">
</a>
          </div>
        </div>
        <div class="shop-products">
          <div class="shop-products__header">
            ...
            <div class="shop-products__menu">
              <img src="assets/img/productos/list.png">
              <img src="assets/img/productos/menu.png">
            </div>
          </div>
          <div class="container-grid">
            <div class="main-featured__product">
              <div class="main-featured__img">
                <img src="assets/img/new-in/image-1_2.png">
              </div>
...
Aretes de estrellas - Dorado
            ...
            <div class="main-featured__product">
              <div class="main-featured__img">
                <img src="assets/img/new-in/image-1.png">
              </div>
              <div class="main-featured__text">
                <a class="main-featured__title" href="">
Aretes de estrellas - Dorado
            ...
            <div class="main-featured__product">
              <div class="main-featured__img">
                <img src="assets/img/new-in/image_2.png">
              </div>
              <div class="main-featured__text">
                <a class="main-featured__title" href="">
Aretes de estrellas - Dorado
            ...
            <div class="main-featured__product">
              <div class="main-featured__img">
                <img src="assets/img/new-in/image_3.png">
              </div>
              <div class="main-featured__text">
                <a class="main-featured__title" href="">
Aretes de estrellas - Dorado
...
Aretes de estrellas - Dorado
          ...
          <div class="blog-general__paginator blog-general__paginator--center">
            ...
            <a href="">...</a>
            <a href="">
<img src="assets/img/blog/next.png">
</a>
          </div>
        </div>
      </div>
