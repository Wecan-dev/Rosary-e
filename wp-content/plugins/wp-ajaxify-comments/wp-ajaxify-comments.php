		...
		array(
			...
			'options' => array(
				...
				'selectorCommentsContainer' => array(
					'type' => 'string',
					'default' => '#comments,.comments-wrapper',
