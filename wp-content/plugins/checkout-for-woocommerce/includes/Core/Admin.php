...
class Admin {
	...
	public function start() {
        ...
        // Hide woocommerce_registration_generate_username setting since we override it
        add_filter( 'woocommerce_get_settings_account', array( $this, 'remove_woocommerce_registration_generate_username' ), 10, 1 );

		// Maybe hide woocommerce_registration_generate_password setting
		add_filter( 'woocommerce_get_settings_account', array( $this, 'maybe_remove_woocommerce_registration_generate_password' ), 10, 1 );
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <label>
                                    <input <?php if ( ! $login_style_enable ) echo 'disabled '; ?>type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('login_style'); ?>" value="enhanced" <?php if ( $login_style == 'enhanced' || empty( $login_style ) ) echo 'checked'; ?> /> <?php cfw_e( 'Enhanced (Recommended)', 'checkout-wc' ); ?><br />
                                </label>
                                <label>
                                    <input <?php if ( ! $login_style_enable ) echo 'disabled '; ?>type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('login_style'); ?>" value="woocommerce" <?php if ( $login_style == 'woocommerce' ) echo 'checked'; ?> /> <?php cfw_e( 'WooCommerce Default', 'checkout-wc' ); ?>
                                </label>
                            </p>
                            <p class="description">
	                        ...
	                        <?php $this->maybe_show_overridden_setting_notice( $login_style_enable === false ); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <label>
                                    <input <?php if ( ! $registration_style_enable ) echo 'disabled '; ?>type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('registration_style'); ?>" value="enhanced" <?php if ( $registration_style == 'enhanced' || empty( $registration_style ) ) echo 'checked'; ?> /> <?php cfw_e( 'Enhanced (Recommended)', 'checkout-wc' ); ?><br />
                                </label>
                                <label>
                                    <input <?php if ( ! $registration_style_enable ) echo 'disabled '; ?>type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('registration_style'); ?>" value="woocommerce" <?php if ( $registration_style == 'woocommerce' ) echo 'checked'; ?> /> <?php cfw_e( 'WooCommerce Default', 'checkout-wc' ); ?>
                                </label>
                            </p>
                            <p class="description">
	                        ...
	                        <?php $this->maybe_show_overridden_setting_notice( $registration_style_enable === false ); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <label>
                                    <input type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('label_style'); ?>" value="floating" <?php if ( $label_style == 'floating' || empty( $label_style ) ) echo 'checked'; ?> /> <?php cfw_e( 'Floating (Recommended)', 'checkout-wc' ); ?><br />
                                </label>
                                <label>
                                    <input type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('label_style'); ?>" value="normal" <?php if ( $label_style == 'normal' ) echo 'checked'; ?> /> <?php cfw_e( 'Normal', 'checkout-wc' ); ?>
                                </label>
                            </p>
                            <p class="description">
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <label>
                                    <input type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('cart_item_link'); ?>" value="disabled" <?php if ( $cart_item_link == 'disabled' || empty( $cart_item_link ) ) echo 'checked'; ?> /> <?php cfw_e( 'Text (Recommended)', 'checkout-wc' ); ?><br />
                                </label>
                                <label>
                                    <input type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('cart_item_link'); ?>" value="enabled" <?php if ( $cart_item_link == 'enabled' ) echo 'checked'; ?> /> <?php cfw_e( 'Link', 'checkout-wc' ); ?>
                                </label>
                            </p>
                            <p class="description">
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <label>
                                    <input <?php if ( ! $cart_item_data_display_enable ) echo 'disabled '; ?>type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('cart_item_data_display'); ?>" value="short" <?php if ( $cart_item_data_display == 'short' || empty( $cart_item_data_display ) ) echo 'checked'; ?> /> <?php cfw_e( 'Short (Recommended)', 'checkout-wc' ); ?><br />
                                </label>
                                <label>
                                    <input <?php if ( ! $cart_item_data_display_enable ) echo 'disabled '; ?>type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('cart_item_data_display'); ?>" value="woocommerce" <?php if ( $cart_item_data_display == 'woocommerce' ) echo 'checked'; ?> /> <?php cfw_e( 'WooCommerce Default', 'checkout-wc' ); ?>
                                </label>
                            </p>
                            <p class="description">
		                    ...
		                    <?php $this->maybe_show_overridden_setting_notice( $cart_item_data_display_enable === false ); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('skip_shipping_step'); ?>" id="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('skip_shipping_step'); ?>" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('skip_shipping_step') == "yes" ) echo "checked"; ?> /> <?php cfw_e('Skip shipping step', 'checkout-wc'); ?></label>
                    ...
                    <tr>
                        ...
                        <td>
                            <input <?php if ( ! $order_notes_enable ) echo 'disabled '; ?>type="hidden" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_order_notes'); ?>" value="no" />
                            <label><input <?php if ( ! $order_notes_enable ) echo 'disabled '; ?>type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_order_notes'); ?>" id="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_order_notes'); ?>" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('enable_order_notes') == "yes" ) echo "checked"; ?> /> <?php cfw_e('Enable Order Notes field', 'checkout-wc'); ?></label>
                            <p><span class="description"><?php cfw_e('Enable or disable order notes field. Disabled by default.', 'checkout-wc'); ?></span></p>
	                        <?php $this->maybe_show_overridden_setting_notice( $order_notes_enable === false, $order_notes_notice_replacement_text ); ?>
                        </td>
                    </tr>
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_coupon_code_link'); ?>" id="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_coupon_code_link'); ?>" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting( 'enable_coupon_code_link' ) == "yes" ) echo "checked"; ?> /> <?php cfw_e( 'Enable link to reveal coupon code field.', 'checkout-wc' ); ?></label>
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('show_mobile_coupon_field'); ?>" id="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('show_mobile_coupon_field'); ?>" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting( 'show_mobile_coupon_field' ) == "yes" ) echo "checked"; ?> /> <?php cfw_e( 'Show coupon field above payment options on mobile.', 'checkout-wc' ); ?></label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('show_logos_mobile'); ?>" id="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('show_logos_mobile'); ?>" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('show_logos_mobile') == "yes" ) echo "checked"; ?> /> <?php cfw_e('Enable credit card logos on mobile', 'checkout-wc'); ?></label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label for="<?php echo $tracking_field_name; ?>">
                                <input type="checkbox" name="<?php echo $tracking_field_name; ?>" id="<?php echo $tracking_field_name; ?>" value="<?php echo md5( trailingslashit( home_url() ) ); ?>" <?php if ( $tracking_value == md5( trailingslashit( home_url() ) ) ) echo "checked"; ?> />
								<?php cfw_e('Allow Checkout for WooCommerce to track plugin usage?', 'checkout-wc'); ?>
                            </label>
                        </td>
                    </tr>

                    <?php if( defined('CFW_DEV_MODE') && CFW_DEV_MODE ):
    ...
    function integrations_tab() {
	    ...
	    <form name="settings" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            ...
            <table class="form-table">
                <tbody>
                    <?php do_action( 'cfw_admin_integrations_settings', $this ); ?>
                </tbody>
            </table>
				...
				<tbody>
					<tr>
						...
						<td>
							<p>
								<label>
									<input type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('template_loader'); ?>" value="redirect" <?php if ( $template_loader == 'redirect' || empty( $template_loader ) ) echo 'checked'; ?> /> <?php cfw_e( 'Distraction Free Portal (Recommended)', 'checkout-wc' ); ?><br />
								</label>
								<label>
									<input type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('template_loader'); ?>" value="content" <?php if ( $template_loader == 'content' ) echo 'checked'; ?> /> <?php cfw_e( 'WordPress Theme', 'checkout-wc' ); ?>
								</label>
							</p>
							<p class="description">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_order_pay'); ?>" id="enable_order_pay" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('enable_order_pay') == "yes" ) echo "checked"; ?> <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> /> <?php cfw_e('Enable support for order pay page.', 'checkout-wc'); ?></label>
                            <p><span class="description"><?php cfw_e('Use checkout template for order pay page.', 'checkout-wc'); ?></span></p>
                        </td>
                    </tr>
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_one_page_checkout'); ?>" id="enable_one_page_checkout" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('enable_one_page_checkout') == "yes" ) echo "checked"; ?> <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> /> <?php cfw_e('Enable one page checkout.', 'checkout-wc'); ?></label>
							<p><span class="description"><?php cfw_e('Show all checkout fields on one tab. Useful for digital stores or stores that force the billing and shipping address to be the same.', 'checkout-wc'); ?></span></p>
						</td>
					</tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_thank_you_page'); ?>" id="enable_thank_you_page" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('enable_thank_you_page') == "yes" ) echo "checked"; ?> <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> /> <?php cfw_e('Enable support for thank you page.', 'checkout-wc'); ?></label>
                            <p><span class="description"><?php cfw_e('Enable thank you page / order received template. This template is also used when viewing orders in My Account.', 'checkout-wc'); ?></span></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label>
                                <select multiple class="wc-enhanced-select" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('thank_you_order_statuses'); ?>[]" id="thank_you_order_statuses" <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?>>
                                    <?php if ( is_array( wc_get_order_statuses() ) ) : ?>
                                        <?php foreach( wc_get_order_statuses() as $key => $status ): ?>
                                            <option value="<?php echo esc_attr( $key ); ?>" <?php if ( is_array( $thank_you_order_statuses ) && in_array( $key, $thank_you_order_statuses ) ) echo 'selected'; ?>><?php echo esc_html( $status ); ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            </label>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_map_embed'); ?>" id="enable_map_embed" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('enable_map_embed') == "yes" ) echo "checked"; ?> <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> /> <?php cfw_e('Enable map embed.', 'checkout-wc'); ?></label>
                            <p><span class="description"><?php cfw_e('Enable or disable map embed on thank you page. Requires Google API key.', 'checkout-wc'); ?></span></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('override_view_order_template'); ?>" id="override_view_order_template" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('override_view_order_template') == "yes" ) echo "checked"; ?> <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> /> <?php cfw_e('Use thank you template for viewing orders in My Account.', 'checkout-wc'); ?></label>
                            <p><span class="description"><?php cfw_e('When checked, viewing orders in My Account will use the thank you page template.', 'checkout-wc'); ?></span></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label><input type="checkbox" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('enable_address_autocomplete'); ?>" id="enable_address_autocomplete" value="yes" <?php if ( $this->plugin_instance->get_settings_manager()->get_setting('enable_address_autocomplete') == "yes" ) echo "checked"; ?> <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> /> <?php cfw_e('Enable address autocomplete.', 'checkout-wc'); ?></label>
                            <p><span class="description"><?php cfw_e('Enable or disable address autocomplete feature. Requires Google API key.', 'checkout-wc'); ?></span></p>
                        </td>
                    </tr>
					...
					<tr>
						...
						<td>
							<p>
								<label>
									<input <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('user_matching'); ?>" value="enabled" <?php if ( $user_matching == 'enabled' || empty( $user_matching ) ) echo 'checked'; ?> /> <?php cfw_e( 'Enabled (Recommended)', 'checkout-wc' ); ?><br />
								</label>
								<label>
									<input <?php if ( $this->_license_activations < 0 ): ?>disabled="disabled"<?php endif; ?> type="radio" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name('user_matching'); ?>" value="woocommerce" <?php if ( $user_matching == 'woocommerce' ) echo 'checked'; ?> /> <?php cfw_e( 'WooCommerce Default', 'checkout-wc' ); ?>
								</label>
							</p>
							<p class="description">
                    ...
                    <tr>
                        ...
                        <td>
	                        <?php if ( $this->_license_activations < 0 ): ?>
	                        <div id="cfw_textarea_placeholder"></div>
	                        <?php else: ?>
	                            <?php wp_editor( $this->plugin_instance->get_settings_manager()->get_setting( 'php_snippets' ), sanitize_title_with_dashes( $this->plugin_instance->get_settings_manager()->get_field_name( 'php_snippets' ) ), array('textarea_rows' => 10, 'textarea_name' => $this->plugin_instance->get_settings_manager()->get_field_name( 'php_snippets' ), 'tinymce' => false, 'media_buttons' => false, 'quicktags' => false ) ); ?>
	                        <?php endif; ?>
                            <p>
                                <span class="description">
    ...
    function maybe_display_upgrade_required_notice( $min_activations = 0 ) {
                ...
                <?php foreach( $templates as $template ):
                    ...
                    <div class="theme <?php if ( $active ) echo "active"; ?>">
                        ...
                        <div class="theme-id-container">
                            ...
                            <h2 class="theme-name" id="<?php echo $template->get_slug(); ?>-name"><strong><?php if ( $active ) cfw_e('Active: '); ?></strong><?php echo $template->get_name(); ?></h2>
    ...
    public function design_tab() {
        ...
        <form name="settings" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
            ...
            <p><?php echo sprintf( cfw__( 'These settings apply to your selected theme. (%s)', 'checkout-wc' ), $this->plugin_instance->get_templates_manager()->getActiveTemplate()->get_name() ); ;?></p>
            <hr>

	        <?php $template_path = $this->plugin_instance->get_templates_manager()->getActiveTemplate()->get_slug(); ?>
                        ...
                        <td>
                            <select id="cfw-body-font-selector" class="wc-enhanced-select" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name( 'body_font' ); ?>">
                                ...
                                <?php foreach( $cfw_google_fonts_list->items as $font ): ?>
                                    <option value="<?php echo $font->family; ?>" <?php if( $font->family == $current_body_font ) echo 'selected="selected"'; ?>><?php echo $font->family; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="cfw-heading-font-selector" class="wc-enhanced-select" name="<?php echo $this->plugin_instance->get_settings_manager()->get_field_name( 'heading_font' ); ?>">
                                ...
                                <?php foreach( $cfw_google_fonts_list->items as $font ): ?>
                                    <option value="<?php echo $font->family; ?>" <?php if( $font->family == $current_heading_font ) echo 'selected="selected"'; ?>><?php echo $font->family; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
            ...
            <table class="form-table template-settings template-<?php echo $template_path; ?>">
                <tbody>
                    <?php foreach( $this->plugin_instance->get_theme_color_settings() as $key => $label ): ?>
						...
						$default_value = $this->plugin_instance->get_templates_manager()->getActiveTemplate()->get_default_setting( $key );
                    	?>
                        <tr>
                            <th scope="row" valign="top">
	...
	public function admin_scripts() {
	    if ( ! empty( $_GET['page'] ) && $_GET['page'] == 'cfw-settings' ) {
		    ...
		    if ( ! empty( $_GET['subpage'] ) && $_GET['subpage'] == 'design' ) {
			    global $cfw_google_fonts_list;
    ...
    function template_disabled_notice() {
	    ...
	    if ( ! $enabled && ! empty( $license_key ) && $key_status == 'valid' ) {
		    $important = '';
		    if ( isset($_GET['page']) && $_GET['page'] == 'cfw-settings') {
			    $important = "style='display:block !important'";
		    }
    ...
    function maybe_do_data_upgrades() {
	    ...
	    if ( version_compare( '3.0.0', $db_version, '>' ) ) {
		    $this->plugin_instance->get_templates_manager()->getActiveTemplate()->init();
	 ...
	 */
    function remove_woocommerce_registration_generate_username( $settings ) {
	    foreach( $settings as $key => $setting ) {
		    if ( $setting['id'] == 'woocommerce_registration_generate_username' ) {
			    unset( $settings[ $key ] );
		    }
	    }
	 ...
	 * @return mixed
	 */
    function maybe_remove_woocommerce_registration_generate_password( $settings ) {
        if ( cfw_get_main()->get_settings_manager()->get_setting( 'registration_style' ) !== 'woocommerce' ) {
            foreach( $settings as $key => $setting ) {
                if ( $setting['id'] == 'woocommerce_registration_generate_password' ) {
                    unset( $settings[ $key ] );
                }
            }
        }
	...
	public function maybe_upload_settings() {
		...
		if ( ! wp_verify_nonce( $nonce, 'import_cfw_settings_nonce' ) || ( empty( $_FILES['uploaded_settings'] ) || $_FILES['uploaded_settings']['size'] == 0 ) ) {
		...
		if ( ! empty( $upload ) ) {
			...
			if ( $file_extension === 'json' ) {
				...
				if ( move_uploaded_file( $file_tmp_path, $dest_path ) ) {
                    ...
                    if ( ! is_null( $decoded ) && isset( $decoded['logo_attachment_id'] ) && ! empty( $decoded['logo_attachment_id'] && $decoded['logo_attachment_url'] !== false ) ) {
