...
class StripeWooCommerce extends Base {
	...
	public function run() {
		...
		add_action( 'cfw_checkout_customer_info_tab', array( $this, 'add_separator' ), 12 ); // This should be 12, which is after 11, which is the hook other gateways use
	}
}