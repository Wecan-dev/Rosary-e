...
abstract class Loader {
	...
	public static function init_checkout() {
		 ...
		 * Add body classes
		 */
		add_filter( 'body_class', function( $css_classes ) {
	 ...
	 */
	public static function display( $global_template_parameters, $template_file ) {
		// Fire off an action before we load the template pieces
		do_action( 'cfw_template_before_load', $template_file );

		// Load content template
		cfw_get_main()->get_templates_manager()->getActiveTemplate()->view( $template_file, $global_template_parameters );
	...
	public static function output_custom_styles() {
		...
		<style>
			...
			main.checkoutwc .cfw-bottom-controls .cfw-primary-btn:hover, main.checkoutwc .place-order .cfw-primary-btn:hover {
