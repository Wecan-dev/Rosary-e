            ...
            <form class="vi-ui form" method="post">
				...
				if ( is_array( $id ) && count( $id ) ) {
					...
					for ( $i = 0; $i < sizeof( $id ); $i ++ ) {
						...
						?>
                        <div class="woo-sctr-accordion-wrap woo-sctr-accordion-wrap-<?php echo $i; ?> vi-ui segment"
                             data-accordion_id="<?php echo $i; ?>">
                            <div class="woo-sctr-accordion">
                                <div class="vi-ui toggle checkbox">
                                    <input type="hidden" name="woo_ctr_active[]"
                                           class="woo-sctr-active"
                                           value="<?php echo $this->settings->get_active()[ $i ]; ?>">
                                    <input type="checkbox"
                                           class="woo-sctr-active" <?php echo $this->settings->get_active()[ $i ] ? 'checked' : ''; ?>><label>
                                </div>
                                <span class="woo-sctr-accordion-name"><?php echo $this->settings->get_names()[ $i ]; ?></span>
                                ...
                                <span class="woo-sctr-short-description">
                                    <span class="woo-sctr-short-description-from"><?php echo esc_html__( 'From: ', 'sales-countdown-timer' ) ?>
                                        <span class="woo-sctr-short-description-from-date"><?php echo $this->settings->get_sale_from_date()[ $i ] ?></span>&nbsp;
                                        <span class="woo-sctr-short-description-from-time"><?php echo $this->settings->get_sale_from_time()[ $i ]; ?></span>
                                    </span>
                                    <span class="woo-sctr-short-description-to"><?php echo esc_html__( 'To: ', 'sales-countdown-timer' ) ?>
                                        <span class="woo-sctr-short-description-to-date"><?php echo $this->settings->get_sale_to_date()[ $i ] ?></span>&nbsp;
                                        <span class="woo-sctr-short-description-to-time"><?php echo $this->settings->get_sale_to_time()[ $i ]; ?></span>
                                    </span>
                                </span>
                                ...
                                <div class="content  <?php if ( $this->settings->get_active()[ $i ] ) {
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="woo_ctr_name[]" class="woo-sctr-name"
                                               value="<?php echo $this->settings->get_names()[ $i ]; ?>">
                                    </div>
                                                ...
                                                <div class="two fields">
                                                    <div class="field">
                                                        <input type="date"
                                                               ...
                                                               value="<?php echo $this->settings->get_sale_from_date()[ $i ] ?>">
                                                    </div>
                                                    <div class="field">
                                                        <input type="time"
                                                               name="woo_ctr_sale_from_time[]"
                                                               class="woo-sctr-sale-from-time"
                                                               value="<?php echo $this->settings->get_sale_from_time()[ $i ] ? $this->settings->get_sale_from_time()[ $i ] : '00:00' ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="field">
                                                ...
                                                <div class="two fields">
                                                    <div class="field">
                                                        <input type="date" name="woo_ctr_sale_to_date[]"
                                                               ...
                                                               value="<?php echo $this->settings->get_sale_to_date()[ $i ] ?>">
                                                    </div>
                                                    <div class="field">
                                                        <input type="time" name="woo_ctr_sale_to_time[]"
                                                               class="woo-sctr-sale-to-time"
                                                               value="<?php echo $this->settings->get_sale_to_time()[ $i ] ? $this->settings->get_sale_to_time()[ $i ] : '00:00' ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class=" content">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" name="woo_ctr_message[]"
                                               ...
                                               value="<?php echo $this->settings->get_message()[ $i ]; ?>">
                                    </div>
                                    <div class="field">
                                        <p>{countdown_timer}
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="hidden"
                                               ...
                                               value="<?php echo $this->settings->get_display_type()[ $i ]; ?>">
                                                    ...
                                                    <div class="fields">
                                                        <div class="three wide field">
                                                            <div class="vi-ui toggle checkbox">
                                                                ...
                                                                <input type="radio"
                                                                       name="woo_ctr_display_type_<?php echo $i; ?>"
                                                                    ...
                                                                    <div class="woo-sctr-shortcode-countdown-wrap woo-sctr-shortcode-countdown-style-1">
                                                                        <div class="woo-sctr-shortcode-countdown">
                                                                            <div class="woo-sctr-shortcode-countdown-1">
                                                                                <span class="woo-sctr-shortcode-countdown-text-before"><?php echo $text_before; ?></span>
                                                                                <div class="woo-sctr-shortcode-countdown-2">
                                                                                    <span class="woo-sctr-shortcode-countdown-unit-wrap">
                                                                                        <span class="woo-sctr-shortcode-countdown-date woo-sctr-shortcode-countdown-unit">
                                                                                            <span class="woo-sctr-shortcode-countdown-date-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-top" <?php echo $datetime_unit_position == 'top' ? '' : 'style="display:none;"'; ?>><?php echo $date; ?></span>
                                                                                            ...
                                                                                            <span class="woo-sctr-shortcode-countdown-date-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-bottom" <?php echo $datetime_unit_position == 'bottom' ? '' : 'style="display:none;"'; ?>><?php echo $date; ?></span>
                                                                                        </span>
                                                                                    </span>
                                                                                    ...
                                                                                    <span class="woo-sctr-shortcode-countdown-unit-wrap">
                                                                                        <span class="woo-sctr-shortcode-countdown-hour woo-sctr-shortcode-countdown-unit">
                                                                                            <span class="woo-sctr-shortcode-countdown-hour-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-top" <?php echo $datetime_unit_position == 'top' ? '' : 'style="display:none;"'; ?>><?php echo $hour; ?></span>
                                                                                            ...
                                                                                            <span class="woo-sctr-shortcode-countdown-hour-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-bottom" <?php echo $datetime_unit_position == 'bottom' ? '' : 'style="display:none;"'; ?>><?php echo $hour; ?></span>
                                                                                        </span>
                                                                                    </span>
                                                                                    <span class="woo-sctr-shortcode-countdown-time-separator"><?php echo $time_separator; ?></span>
                                                                                    <span class="woo-sctr-shortcode-countdown-unit-wrap">
                                                                                        <span class="woo-sctr-shortcode-countdown-minute woo-sctr-shortcode-countdown-unit">
                                                                                            <span class="woo-sctr-shortcode-countdown-minute-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-top" <?php echo $datetime_unit_position == 'top' ? '' : 'style="display:none;"'; ?>><?php echo $minute; ?></span>
                                                                                            ...
                                                                                            <span class="woo-sctr-shortcode-countdown-minute-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-bottom" <?php echo $datetime_unit_position == 'bottom' ? '' : 'style="display:none;"'; ?>><?php echo $minute; ?></span>
                                                                                        </span>
                                                                                    </span>
                                                                                    <span class="woo-sctr-shortcode-countdown-time-separator"><?php echo $time_separator; ?></span>
                                                                                    <span class="woo-sctr-shortcode-countdown-unit-wrap">
                                                                                        <span class="woo-sctr-shortcode-countdown-second woo-sctr-shortcode-countdown-unit">
                                                                                            <span class="woo-sctr-shortcode-countdown-second-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-top" <?php echo $datetime_unit_position == 'top' ? '' : 'style="display:none;"'; ?>><?php echo $second; ?></span>
                                                                                            ...
                                                                                            <span class="woo-sctr-shortcode-countdown-second-text woo-sctr-shortcode-countdown-text woo-sctr-datetime-unit-position-bottom" <?php echo $datetime_unit_position == 'bottom' ? '' : 'style="display:none;"'; ?>><?php echo $second; ?></span>
                                                                                        </span>
                                                                                    </span>
                                                                                </div>
                                                                                <span class="woo-sctr-shortcode-countdown-text-after"><?php echo $text_after; ?></span>
                                                        ...
                                                        <div class="woo-sctr-shortcode-wrap-wrap woo-sctr-shortcode-wrap-wrap-inline">
                                                            ...
                                                            <span class="woo-sctr-shortcode-countdown-1">
                                                                <span class="woo-sctr-shortcode-countdown-unit-wrap">
                                                                    <span class="woo-sctr-shortcode-countdown-date woo-sctr-shortcode-countdown-unit">
                                                                        <span class="woo-sctr-shortcode-countdown-date-value woo-sctr-shortcode-countdown-value"><?php esc_html_e( '01', 'sales-countdown-timer' ); ?></span>
                                                                        <span class="woo-sctr-shortcode-countdown-date-text woo-sctr-shortcode-countdown-text"><?php echo $date; ?></span>
                                                                    </span>
                                                                </span>
                                                                <span class="woo-sctr-shortcode-countdown-time-separator"><?php echo $time_separator; ?></span>
                                                                <span class="woo-sctr-shortcode-countdown-unit-wrap">
                                            ...
                                            <div class="vi-ui segment">
                                                ...
                                                <div class="vi-ui toggle checkbox">
                                                    ...
                                                    <input type="hidden" name="woo_ctr_circle_smooth_animation[]"
                                                           ...
                                                           value="<?php echo $smooth_animation; ?>">
                                                    <input type="checkbox"
                                        ...
                                        <div class="three fields">
                                            <div class="field">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_countdown_timer_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_countdown_timer_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_countdown_timer_bg_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_countdown_timer_bg_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_countdown_timer_border_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_countdown_timer_border_color()[ $i ] ?>">
                                            </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <input type="number"
                                                       ...
                                                       min="0"
                                                       value="<?php echo $this->settings->get_countdown_timer_padding()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="number"
                                                       ...
                                                       min="0"
                                                       value="<?php echo $this->settings->get_countdown_timer_border_radius()[ $i ] ?>">
                                            </div>
                                        ...
                                        <div class="three fields">
                                            <div class="field">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_countdown_timer_item_border_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_countdown_timer_item_border_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="number"
                                                       ...
                                                       min="0"
                                                       value="<?php echo $this->settings->get_countdown_timer_item_border_radius()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="number"
                                                       ...
                                                       min="0"
                                                       value="<?php echo $this->settings->get_countdown_timer_item_height()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="number"
                                                       ...
                                                       min="0"
                                                       value="<?php echo $this->settings->get_countdown_timer_item_width()[ $i ] ?>">
                                            </div>
                                        ...
                                        <div class="equal width fields">
                                            <div class="field">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_datetime_value_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_datetime_value_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                <label><?php esc_html_e( 'Background', 'sales-countdown-timer' ) ?></label>
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_datetime_value_bg_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_datetime_value_bg_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                ...
                                                <input type="number"
                                                       ...
                                                       min="0"
                                                       value="<?php echo $this->settings->get_datetime_value_font_size()[ $i ] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="field">
                                        ...
                                        <div class=" equal width fields">
                                            <div class="field">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_datetime_unit_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_datetime_unit_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                <label><?php esc_html_e( 'Background', 'sales-countdown-timer' ) ?></label>
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_datetime_unit_bg_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_datetime_unit_bg_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                <label><?php esc_html_e( 'Font size(px)', 'sales-countdown-timer' ) ?></label>
                                                <input type="number"
                                                       ...
                                                       min="0"
                                                       value="<?php echo $this->settings->get_datetime_unit_font_size()[ $i ] ?>">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="vi-ui toggle checkbox">
                                                    <input type="hidden" name="woo_ctr_stick_to_top[]"
                                                           ...
                                                           value="<?php echo isset( $this->settings->get_stick_to_top()[ $i ] ) ? $this->settings->get_stick_to_top()[ $i ] : ''; ?>">
                                                    <input type="checkbox"
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="vi-ui toggle checkbox">
                                                    <input type="hidden" name="woo_ctr_shop_page[]"
                                                           ...
                                                           value="<?php echo $this->settings->get_shop_page()[ $i ]; ?>">
                                                    <input type="checkbox"
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="vi-ui toggle checkbox">
                                                    <input type="hidden" name="woo_ctr_category_page[]"
                                                           ...
                                                           value="<?php echo $this->settings->get_category_page()[ $i ]; ?>">
                                                    <input type="checkbox"
                                            ...
                                            <div class="field">
                                                ...
                                                <div class="inline field">
                                                    <input type="number" name="woo_ctr_size_on_archive_page[]" min="30"
                                                           ...
                                                           value="<?php echo isset( $this->settings->get_size_on_archive_page()[ $i ] ) ? $this->settings->get_size_on_archive_page()[ $i ] : '75'; ?>">%
                                                </div>
                                            </div>
                                        ...
                                        <div class="fields">
                                            <div class="three wide field">
                                                ...
                                                <div class="vi-ui toggle checkbox">
                                                    <input type="hidden" name="woo_ctr_upcoming[]"
                                                           ...
                                                           value="<?php echo $this->settings->get_upcoming()[ $i ]; ?>">
                                                    <input type="checkbox"
                                            ...
                                            <div class="thirteen wide field">
                                                ...
                                                <input type="text" name="woo_ctr_upcoming_message[]"
                                                       ...
                                                       value="<?php echo $this->settings->get_upcoming_message()[ $i ]; ?>">
                                                <p>{countdown_timer}
                                                    - <?php esc_html_e( 'The countdown timer that you set on tab design', 'sales-countdown-timer' ) ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="vi-ui input">
                                                <input type="text" name="woo_ctr_progress_bar_message[]"
                                                       ...
                                                       value="<?php echo $this->settings->get_progress_bar_message()[ $i ] ?>">
                                            </div>
                                        ...
                                        <div class="equal width fields">
                                            ...
                                            <div class="field">
                                                ...
                                                <input type="number" min="0"
                                                       ...
                                                       value="<?php echo $this->settings->get_progress_bar_width()[ $i ]; ?>">
                                            </div>
                                            <div class="field">
                                                <label><?php esc_html_e( 'Height(px)', 'sales-countdown-timer' ) ?></label>
                                                <input type="number" min="0"
                                                       ...
                                                       value="<?php echo $this->settings->get_progress_bar_height()[ $i ]; ?>">
                                            </div>
                                        </div>
                                        <div class="three fields">
                                            <div class="field">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_progress_bar_bg_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_progress_bar_bg_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                <label><?php esc_html_e( 'Color', 'sales-countdown-timer' ) ?></label>
                                                <input type="text"
                                                       ...
                                                       value="<?php echo $this->settings->get_progress_bar_color()[ $i ] ?>"
                                                       style="background:<?php echo $this->settings->get_progress_bar_color()[ $i ] ?>">
                                            </div>
                                            <div class="field">
                                                <label><?php esc_html_e( 'Border radius(px)', 'sales-countdown-timer' ) ?></label>
                                                <input type="number" min="0"
                                                       ...
                                                       value="<?php echo $this->settings->get_progress_bar_border_radius()[ $i ]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
